...
void basReadSock()
{
    ...
    numbytes= popNumber();
    sock= popNumber();
    pushStringCopy( readsock(sock,numbytes));
}
...
void basReadLineSock()
{
    ...
    sock= popNumber();
    pushStringCopy(readlinesock(sock));
}
//_______________________________________________________________________________________________________________________
...
void basGetRemoteIp()
{
    ...
    sock= popNumber();
    pushStringCopy(getremoteip(sock));
}
//_______________________________________________________________________________________________________________________
